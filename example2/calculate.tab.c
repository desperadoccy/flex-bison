...
#line 15 "calculate.y"
                    { printf("%d\n", yyvsp[-1]); }
#line 1062 "calculate.tab.c"
    break;

  case 4: /* expr: INTEGER  */
#line 20 "calculate.y"
          { yyval = yyvsp[0]; }
#line 1068 "calculate.tab.c"
    break;

  case 5: /* expr: expr '*' expr  */
#line 21 "calculate.y"
                  { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1074 "calculate.tab.c"
    break;

  case 6: /* expr: expr '/' expr  */
#line 22 "calculate.y"
                  { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1080 "calculate.tab.c"
    break;

  case 7: /* expr: expr '+' expr  */
#line 23 "calculate.y"
                  { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1086 "calculate.tab.c"
    break;

  case 8: /* expr: expr '-' expr  */
#line 24 "calculate.y"
                  { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1092 "calculate.tab.c"
    break;
